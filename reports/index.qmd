...
![The closest health facility to Mandruzi is Centro de Saude de Dondo](figures/moz-static-focus.svg){#fig-static fig-align="left" width=100%}
...
![Mandruzi is approx. 4km (49mins walk) to Centro de Saude de Dondo](figures/fig2-screenshot.png){#fig-dynamic fig-align="left" width=100%}
:::

:::{.content-visible unless-format="typst"}
:::: {#fig-dynamic}
<iframe width=100% height=600px src="figures/moz-dynamic-mandruzi.html"></iframe>
...
::: {.content-visible when-format="typst"}
![A screenshot of all sites](figures/fig3-screenshot.png){#fig-dynamic2 fig-align="left" width=100%}
:::
:::{.content-visible when-format="html"}
:::: {#fig-dynamic2}
<iframe width=100% height=600px src="figures/moz-dynamic-all.html"></iframe>
...
![The median travel time to a health facility is 128 minutes](figures/moz-static-hist-computed.svg){#fig-hist-computed fig-align="left" width=100%}
...
![KI responses were limited to four time periods](figures/moz-static-hist-ki.svg){#fig-hist-ki fig-align="left" width=100%}
...
![Comparing KI responses to computed times](figures/moz-static-bar-comparison.svg){#fig-bar-comparison fig-align="left" width=100%}
...
:::{.content-visible when-format="html"}
:::: {#fig-dynamic3}
<iframe width=100% height=600px src="figures/moz-dynamic-match.html"></iframe>
There are clusters of sites near Quilimane and west of Guara-Guara that are mostly mismatched
::::
:::
::: {.content-visible when-format="typst"}
![There are clusters of sites near Quilimane and west of Guara-Guara that are mostly mismatched
](figures/figmatch-screenshot.png){#fig-dynamic3 fig-align="left" width=100%}
:::
